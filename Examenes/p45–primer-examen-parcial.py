...
print("------Universidad Autónoma de los Olvera------")
print("---Sistema de Inscripción a Congreso de CiberSeguridad---")

total_ventas_dia = 0  

while True:        
    print("\nSelecciona el tipo de usuario a inscribirse:")
    print("[1] Alumno $100")
    ...
    print("Ingresa la cantidad de isncripciones")
    cantidad = int(input("  > "))
